package Kolokvium1Vezbi.FileSystem;
...
interface IFile extends Comparable<IFile> {
	...
	String getFileInfo(int indent); // kolku tabs
...
class Folder extends File implements IFile {
	...
	List<IFile> files;
	//Vo folder vekje ima ime od file
	...
	@Override
	public long getFileSize() { //od site files
		return files.stream()
